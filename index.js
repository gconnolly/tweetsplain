                      ...
                      request(
                        {
                          ...
                          method: 'POST',
                          json: {
                            'params': 'query=%22' + encodeURIComponent(tweet.text) + '%22&sort=byDate'
                          }
                        },
                        (error, response, body) => {
                          if (error) {
                            ...
                            if (body && body.hits && body.hits[0]) {
                              resolve('@' + req.body.username + ' https://hn.algolia.com/?query=' + encodeURIComponent(tweet.text) + '&type=all&sort=byDate ' + body.hits[0].story_url)
                            } else {
